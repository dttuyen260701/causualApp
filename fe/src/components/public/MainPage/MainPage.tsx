...
import { Box, Heading, HStack, Image, Link, VStack, Text, Img, AspectRatio, Flex } from "@chakra-ui/react";
	...
	return (
		<VStack width={"100%"} padding="0px" spacing={5} backgroundColor="#fffcf8">
			<HStack width={"100%"} justifyContent="space-between" position={"relative"} paddingBottom="100px">
				<VStack width={"50%"}>
					<Heading color={"#532d29"}>ỨNG DỤNG TÌM KIẾM</Heading>
					<Heading color={" #d49457"}>DỊCH VỤ THỜI VỤ</Heading>
					...
					<HStack width={"100%"} spacing={0} padding="0px 10px" paddingTop="50px">
						<VStack width={"35%"} justify="center">
							<Text fontSize={"40px"} fontWeight="600" color={"#532d29"}>
								20<span style={{ color: "#c75422" }}>+</span>
							</Text>
			...
			{/* Who we are */}
			<HStack width={"80vw"} height="70vh" bgColor={"#E48D41"} boxShadow="4px 4px 8px #e48d41" borderRadius={"10px"}>
				<VStack
					width="100%"
					height="100%"
					bgColor="#E48D41"
				...
				<VStack width="100%" height="100%" alignItems={"center"} justifyContent="center" padding={"0px 10px"}>
					<Heading color={"white"} fontWeight="300" fontSize={"40px"} paddingBottom="10px">
						CHÚNG TÔI LÀ AI?
					</Heading>
			...
			<VStack>
				...
				<VStack paddingTop={"60px"} paddingBottom="20px">
					<Heading color={"#532d29"}>Những dịch vụ chúng tôi có</Heading>
					<Text color={"#d49457"}>Tất cả những tiện ích gia đình mà bạn cần</Text>
				</VStack>
				<TypeOfJob />
			</VStack>
